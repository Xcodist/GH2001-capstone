    ...
    axios
      .get("https://newsapi.org/v2/everything", {
        params: {
          q: query,
          domains:
            "nytimes.com, theintercept.com, jacobinmag.com, thenation.com, vice.com",
          language: "en",
    ...
    return (
      <div className="Articles">
        <h2 className="headlines">
          Top Headlines
          <img
            src="https://cdn.onlinewebfonts.com/svg/img_573740.png"
            width="30px"
          />
        </h2>
          ...
          <div className="single-article">
            ...
            >
              <img
                ...
                src="https://image.flaticon.com/icons/png/512/38/38311.png"
                width="10px"
              />
              {headline.title}
            </p>
